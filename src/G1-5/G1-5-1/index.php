...
<body>
    <header>
        <div id="app">
            ...
            <div class="sidebar">
                <img id="closeButton" src="../../src/common/img/close.png">
            ...
            <img id="toggleButton" src="../../src/common/img/user.png" width="40" height="40">
            <a href="../../G1-5/G1-5-2/index.php">
                <img id="cart_button" src="../../src/common/img/cart.jpg" width="40" height="40">
            </a>
            ...
            <div id="search_all">
                <form method="get" action="/omiyageEC/src/G1-5/G1-5-2/index.php">
                    ...
                    <button class="conditions_img">
                        <img src="../../src/common/img/search.png" width="20" height="20">
                    </button>
                </form>
            </div>
